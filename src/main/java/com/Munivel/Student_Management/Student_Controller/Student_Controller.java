...
public class Student_Controller {
  @Autowired private Student_Service service;
  ...
  public ResponseEntity<Student> add_Student(
      @RequestBody Student student) { // request body work json data java object convert
